...
<!--     
    ...
    "Times New Roman","serif"'>
                ...
                {$users[$user_id]->initials} {$users[$user_id]->last_name}@if( ($job.user|@count - 1) > $index}, @endif
                @endforeach
    ...
    text-indent:35.45pt'><span style='font-size:12.0pt;font-family:"Times New Roman","serif"'>{$job.job_name}@if( $job.job_city}, {$job.job_city}@endif<o:p></o:p></span></p>
    ...
    text-indent:35.45pt'><span style='font-size:12.0pt;font-family:"Times New Roman","serif"'>
            @foreach( from=$job.user key=index item=user_id}
                ...
                {$users[$user_id].email}@if( ($job.user|@count - 1) > $index}, @endif
                @endif
                @endforeach
            <o:p></o:p></span></p>
...
<!--     <p class=MsoNoSpacing align=right style='text-align:right;text-indent:35.45pt'><b
    ...
    "Times New Roman","serif"'>
                @foreach( from=$job.user key=index item=user_id}
                {$users[$user_id]->initials_en} {$users[$user_id]->name_en}@if( ($job.user|@count - 1) > $index}, @endif
                @endforeach
            </span><o:p></o:p></span></b></p>

    
    <p class=MsoNoSpacing align=right style='margin-left:212.65pt;text-align:right;
    text-indent:35.45pt'><span style='font-size:12.0pt;font-family:"Times New Roman","serif"'>{$job.job_name_en}@if( $job.job_city_en}, {$job.job_city_en}@endif<o:p></o:p></span></p>
