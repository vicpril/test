...
@section('button')
    <a href="{{ route('articles.create') }}" class="btn btn-primary">@lang('New Post')</a>
@endsection
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th>@lang('Public')<span id="status" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                            <th>@lang('Year')<span id="created_at" class="fa fa-sort-desc pull-right" aria-hidden="true"></span></th>
                            <th>@lang('Is.')<span id="created_at" class="fa fa-sort-desc pull-right" aria-hidden="true"></span></th>
                            <th>@lang('P.')<span id="created_at" class="fa fa-sort-desc pull-right" aria-hidden="true"></span></th>
                        ...
                        <tbody id="pannel">
                            @if (session('post-ok'))
                                ...
                                @endcomponent
                            @endif
                            @include('back.articles.table', compact('articles'))
                        </tbody>
                    </table>
                </div>
                <!-- /.box-body -->
